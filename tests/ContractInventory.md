...
| HostContext image preflight and bounded ELF feature rejection, including exact weak-undefined JUMP_SLOT PLT and libc.so.6 GNU-hash version-need validation | `native/urprotect-runtime/host_image_validation.c` | `host_adapter.c`, native self-tests, PLT/dependency fixtures, fixture matrix | sole native owner of relocation, dynsym, GNU-hash, and accepted Verneed-chain validation before image-handle creation |
